"""
Django settings for Nexus LMD project.
...
SECRET_KEY = 'django-insecure-5rx2xe_&n-b!y$fk6-e@5)hsys495fy0pk#99owy&-^%6iven$'
...
MIDDLEWARE = [
    ...
    'core.middleware.CustomComponentMiddleware',
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'core.processors.component_processor',
            ],
        },
    },
]
